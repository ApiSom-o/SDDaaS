...
# กราฟซ้าย: Search Time เปรียบเทียบ Linear vs SDDaaS
# ใช้ log scale บน x-axis เพราะ n กระจายตัวแบบ exponential (100 → 50000)
# คาดหวัง: Linear เพิ่มขึ้นตามสัดส่วนเส้นตรง, SDDaaS แทบคงที่ (O(1))
plt.subplot(1, 2, 1)
...
# กราฟขวา: Storage Cost เปรียบเทียบ Traditional vs SDDaaS
# ใช้ log scale บน x-axis เช่นเดียวกัน
# คาดหวัง: Traditional เพิ่มเป็นเส้นตรงใน log scale, SDDaaS ต่ำกว่าเพราะ deduplication
plt.subplot(1, 2, 2)
